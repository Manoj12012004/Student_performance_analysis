                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="me-auto d-flex justify-content-between" style={{margin:"auto",}} >
                        ...
                        <div className="Btns d-flex justify-content-center">
                            ...
                            <div className="Btn-Free btn d-flex" style={{width:"150%",gap:"1.0rem",}}><p><button  onCLick={props=="input_form"?navigate(`/${props}`):navigate(`${props}`)} style={{color:"white"}}>{props==="input_form"?"Form":"Try It for Free"}</button></p><div><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
