                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="me-auto d-flex justify-content-between" style={{margin:"auto",}} >
                        ...
                        <div className="Btns d-flex justify-content-center">
                            ...
                            <div className="Btn-Free btn d-flex" style={{width:"150%",gap:"1.0rem",}}><p><Link to="input_form" style={{textDecoration:"none",color:"white"}}>{props==="input_form"?"":"Try It for Free"}</Link></p><div><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
