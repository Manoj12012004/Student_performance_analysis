  ...
  const handleShow = () => setShow(true);
    return(
        ...
        <Navbar expand="lg"  id="nav">
            <Container className="block d-flex justify-content-center align-items-center">
                ...
                <Navbar.Collapse className="Menu d-flex justify-content-center align-items-center" id="basic-navbar-nav">
                    <Nav className="Nav-menu me-auto d-flex flex-row" >
                        <Nav.Link className="About" style={{fontSize:"100%",color:"white2"}}>About Analysis</Nav.Link>
                    ...
                    <div className="Btns d-flex">
                        ...
                        <Modal show={show} onHide={handleClose}>
                            ...
                            <Modal.Footer>
                                ...
                                <button type="button" class="btn btn-secondary" ><button onClick={logout}>logout</button></button>
                            </Modal.Footer>
                        </Modal>
                        </div>
                        </div>:<div className="Btn-Login btn m-2 " style={{width:"40%",height:"20%"}}><div className="login "><Link to="/login" style={{textDecoration:"none",color:"blue",textAlign:"center"}}>Login</Link></div></div>}
                        <div className="Btn-Free btn m-2 d-flex" style={{width:"150%",gap:"1.0rem"}}><p><Link to="/register" style={{textDecoration:"none",color:"white"}}>Try this out for free</Link></p><div><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
