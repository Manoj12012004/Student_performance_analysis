                    ...
                    <Nav className="me-auto d-flex justify-content-between" style={{margin:"auto",}} >
                        ...
                        <div className="Btns d-flex justify-content-center">
                            {token?
                                ...
                                :
                                <div className="Btn-Login btn " style={{width:"40%",margin:"auto"}}>
                                    <div className="login "><button onClick={navigate("/login")} style={{textDecoration:"none",color:"blue",textAlign:"center",margin:"auto"}}>Login</button></div>
                                </div>}
                                <div className="Btn-Free btn d-flex" style={{width:"150%",gap:"1.0rem",}}>
                                    <p><button  onCLick={props==="input_form"?navigate(`${props}`):navigate(`/${props}`)} style={{color:"white"}}>{props==="input_form"?"Form":"Try It for Free"}</button></p>
                                    <div>
